...
public class MRWordCountBrowser {
    ...
    public static class ForMapper extends Mapper <LongWritable,Text,Text,NullWritable>{
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            System.out.println(data.getWeb().toString());
            okey.set(data.getWeb().toString());
    ...
    public static void main(String[] args) {
        JobUtil.commitJob(MRWordCountBrowser.class,"E:\\1703\\Hadoop\\作业\\MapReduce经典案例 WordCount 练习题及答案\\MapReduce经典案例 WordCount 练习题及答案\\实验数据","");
    }
}
