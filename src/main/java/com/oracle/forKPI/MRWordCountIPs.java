...
public class MRWordCountIPs {
    ...
    public static void main(String[] args) {
        JobUtil.commitJob(MRWordCountIPs.class,"E:\\1703\\Hadoop\\作业\\MapReduce经典案例 WordCount 练习题及答案\\MapReduce经典案例 WordCount 练习题及答案\\实验数据","");
    }
}
